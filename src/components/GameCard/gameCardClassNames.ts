const gameCardClassNames = {
    container: "relative mx-auto w-[251px] h-[277px] rounded-2xl overflow-hidden transition duration-300 transform focus:scale-110 hover:shadow-lg hover:border-white-500",
